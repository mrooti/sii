  ...
  <section id="container" >
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                            <h4><i class="fa fa-angle-right"></i>Todos los Administradores</h4>
                            <hr>
                              <thead>
                              <tr>
                                  <th><i class="fa fa-bookmark"></i>Administradores</th>
                              ...
                              <?php
                                $cont=0;
                                $resultado=$mysqli->query("SELECT Id_Administrador, Nombres, Apellido_P, Apellido_M, Curp FROM administrador")or die("Error en: ".$mysqli->error);
                      ...
                      <div class=" add-task-row">
                        <a class="btn btn-success btn-sm pull-left" href="alta_administrador.php">Alta Nuevo Administrador</a>
                      </div>
                      <?php
                        $cont2=0;
                        $resultado=$mysqli->query("SELECT ad.Nombres, ad.Apellido_P, ad.Apellido_M, ad.Sexo, ad.Direccion, l.Localidad, m.Municipio, e.Estado, ad.CP, ad.Fecha_Nacimiento, ad.Curp, ad.Email, ad.Telefono, ad.Img FROM administrador ad INNER JOIN localidad l INNER JOIN municipio m INNER JOIN estado e ON ad.Id_Localidad=l.Id_Localidad AND l.Id_Municipio=m.Id_Municipio AND m.Id_Estado=e.Id_Estado WHERE ad.Estado='1'")or die("Error en: ".$mysqli->error);
                        while($row=$resultado->fetch_array(MYSQLI_ASSOC)){
                          echo' <!-- Modal -->
                      ...
                      <div class="modal fade" id="elimiModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ¿Está seguro que desea eliminar el Administrador? No podrá deshacer los cambios.
                            </div>
    ...
    $(document).ready(function() {
      ...
      $('#eliminar').click(function(){
        ...
        $.ajax({
            type: "POST",
            url: "../control/ajax.php?option=42",
            data: dataString,
            success: function() {
