      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Alta de Profesor</h3>
          	<div class="row mt">
          		<div class="col-lg-12">
            		<div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="post" id="formulario" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Cedula Profesional</label>
                              <div class="col-sm-10">
        ...
        $.ajax({
          ...
          success: function(data){
            ...
            if(data.indexOf("success")>=0){
              $("#info").html("<h3>Profesor Agregado Correctamente</h3>");
              $("#info").slideDown(2000);
              $("#info").slideUp(2000);
              return false;
            }
