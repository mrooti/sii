...
<html lang="es">
  ...
  <script>
    ...
    $(document).ready(function(){
      var busqueda=<?php echo $_SESSION["usuario"]; ?>;
    ...
    //comprobar
    $.post("../control/ajax.php?option=28",{permiso:"4"}).done(function(data){
      if(data=="success"){
    ...
    $("#salir").click(function(){
      $.post("../control/ajax.php?option=29",{terminar:4}).done(function(data){
        if(data=="success"){
