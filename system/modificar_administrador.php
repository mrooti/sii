      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Modificar Datos Administrador</h3>
          	<div class="row mt">
          		<div class="col-lg-12">
            		<div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i>Ingresa los datos del administrador</h4>
                      <form class="form-horizontal style-form" method="post" id="formulario" enctype="multipart/form-data">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nombre</label>
                              <div class="col-sm-10">
                                 <?php
                                        $resultado=$mysqli->query("SELECT Nombres FROM administrador WHERE Id_Administrador=".$ide." AND Estado='1'")or die("Error en: ".$mysqli->error);
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <?php
                                        $resultado=$mysqli->query("SELECT Apellido_P FROM administrador WHERE Id_Administrador=".$ide." AND Estado='1'")or die("Error en: ".$mysqli->error);
                                        while($row=$resultado->fetch_array(MYSQLI_ASSOC)){
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                 <?php
                                        $resultado=$mysqli->query("SELECT Apellido_M FROM administrador WHERE Id_Administrador=".$ide." AND Estado='1'")or die("Error en: ".$mysqli->error);
                                        while($row=$resultado->fetch_array(MYSQLI_ASSOC)){
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <select name="sexo" id="sexo" class="form-control" required>
                                    <?php
                                        $resultado=$mysqli->query("SELECT Sexo FROM administrador WHERE Id_Administrador=".$ide." AND Estado='1'")or die("Error en: ".$mysqli->error);
                                        while($row=$resultado->fetch_array(MYSQLI_ASSOC)){
                                          if($row['Sexo']=='M')
                                          {
                                            echo'
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <?php
                                        $resultado=$mysqli->query("SELECT Direccion FROM administrador WHERE Id_Administrador=".$ide." AND Estado='1'")or die("Error en: ".$mysqli->error);
                                        while($row=$resultado->fetch_array(MYSQLI_ASSOC)){
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <?php
                                        $resultado=$mysqli->query("SELECT CP FROM administrador WHERE Id_Administrador=".$ide." AND Estado='1'")or die("Error en: ".$mysqli->error);
                                        while($row=$resultado->fetch_array(MYSQLI_ASSOC)){
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                 <?php
                                        $resultado=$mysqli->query("SELECT Fecha_Nacimiento FROM administrador WHERE Id_Administrador=".$ide." AND Estado='1'")or die("Error en: ".$mysqli->error);
                                        while($row=$resultado->fetch_array(MYSQLI_ASSOC)){
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <?php
                                        $resultado=$mysqli->query("SELECT Curp FROM administrador WHERE Id_Administrador=".$ide." AND Estado='1'")or die("Error en: ".$mysqli->error);
                                        while($row=$resultado->fetch_array(MYSQLI_ASSOC)){
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <?php
                                        $resultado=$mysqli->query("SELECT Email FROM administrador WHERE Id_Administrador=".$ide." AND Estado='1'")or die("Error en: ".$mysqli->error);
                                        while($row=$resultado->fetch_array(MYSQLI_ASSOC)){
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <?php
                                        $resultado=$mysqli->query("SELECT Telefono FROM administrador WHERE Id_Administrador=".$ide." AND Estado='1'")or die("Error en: ".$mysqli->error);
                                        while($row=$resultado->fetch_array(MYSQLI_ASSOC)){
  ...
  <script>
    ...
    $("#formulario").submit(function(){
      if($("#contrasena").val()==$("#contrasena2").val()){
        ...
        $.ajax({
          type: "POST",
          url: "../control/ajax.php?option=45&ide="+idi,
          data: data,
          success: function(data){
            ...
            if(data.indexOf("success")>=0){
              $("#info").html("<h3>Administrador Modificado Correctamente</h3>");
              $("#info").slideDown(2000);
              $("#info").slideUp(2000);
              return false;
            }
