      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Modificar Datos Tutor</h3>
          	<div class="row mt">
          		<div class="col-lg-12">
            		<div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="post" id="formulario" enctype="multipart/form-data">
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                 <?php
                                        $resultado=$mysqli->query("SELECT Nombres FROM tutor WHERE Id_Tutor=".$ide." AND Estado='1'")or die("Error en: ".$mysqli->error);
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <?php
                                        $resultado=$mysqli->query("SELECT Apellido_P FROM tutor WHERE Id_Tutor=".$ide." AND Estado='1'")or die("Error en: ".$mysqli->error);
                                        while($row=$resultado->fetch_array(MYSQLI_ASSOC)){
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                 <?php
                                        $resultado=$mysqli->query("SELECT Apellido_M FROM tutor WHERE Id_Tutor=".$ide." AND Estado='1'")or die("Error en: ".$mysqli->error);
                                        while($row=$resultado->fetch_array(MYSQLI_ASSOC)){
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <select name="sexo" id="sexo" class="form-control" required>
                                    <?php
                                        $resultado=$mysqli->query("SELECT Sexo FROM tutor WHERE Id_Tutor=".$ide." AND Estado='1'")or die("Error en: ".$mysqli->error);
                                        while($row=$resultado->fetch_array(MYSQLI_ASSOC)){
                                          if($row['Sexo']=='M')
                                          {
                                            echo'
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <?php
                                        $resultado=$mysqli->query("SELECT Direccion FROM tutor WHERE Id_Tutor=".$ide." AND Estado='1'")or die("Error en: ".$mysqli->error);
                                        while($row=$resultado->fetch_array(MYSQLI_ASSOC)){
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <?php
                                        $resultado=$mysqli->query("SELECT CP FROM tutor WHERE Id_Tutor=".$ide." AND Estado='1'")or die("Error en: ".$mysqli->error);
                                        while($row=$resultado->fetch_array(MYSQLI_ASSOC)){
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                 <?php
                                        $resultado=$mysqli->query("SELECT Fecha_Nacimiento FROM tutor WHERE Id_Tutor=".$ide." AND Estado='1'")or die("Error en: ".$mysqli->error);
                                        while($row=$resultado->fetch_array(MYSQLI_ASSOC)){
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <?php
                                        $resultado=$mysqli->query("SELECT Curp FROM tutor WHERE Id_Tutor=".$ide." AND Estado='1'")or die("Error en: ".$mysqli->error);
                                        while($row=$resultado->fetch_array(MYSQLI_ASSOC)){
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <?php
                                        $resultado=$mysqli->query("SELECT Email FROM tutor WHERE Id_Tutor=".$ide." AND Estado='1'")or die("Error en: ".$mysqli->error);
                                        while($row=$resultado->fetch_array(MYSQLI_ASSOC)){
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <?php
                                        $resultado=$mysqli->query("SELECT Telefono FROM tutor WHERE Id_Tutor=".$ide." AND Estado='1'")or die("Error en: ".$mysqli->error);
                                        while($row=$resultado->fetch_array(MYSQLI_ASSOC)){
  ...
  <script>
    ...
    $("#formulario").submit(function(){
      if($("#contrasena").val()==$("#contrasena2").val()){
        ...
        $.ajax({
          type: "POST",
          url: "../control/ajax.php?option=46&ide="+idi,
          data: data,
          success: function(data){
            ...
            if(data.indexOf("success")>=0){
              $("#info").html("<h3>Tutor Modificado Correctamente</h3>");
              $("#info").slideDown(2000);
              $("#info").slideUp(2000);
              return false;
            }
